...
class _SearchPageState extends State<SearchPage> {
  ...
  _initiateSearch() async {
    if (searchEditingController.text.isNotEmpty) {
      ...
      await DatabaseService().searchByName(searchEditingController.text).then((
          snapshot) {
  ...
  _joinValueInGroup(String userName, String groupId, String groupName,
      String admin) async {
    bool value = await DatabaseService(uid: _user.uid).isUserJoined(
  ...
  Widget groupTile(String userName, String groupId, String groupName,
    ...
    return ListTile(
      ...
      trailing: InkWell(
        onTap: () async {
          await DatabaseService(uid: _user.uid).togglingGroupJoin(
              groupId, groupName, userName);
          if (_isJoined) {
            setState(() {
              _isJoined = !_isJoined;
