...
class CheckPositionPage1 extends StatefulWidget {
  final result;
  CheckPositionPage1(this.result);
  @override
  CheckPositionPage1State createState() => CheckPositionPage1State();
}

class CheckPositionPage1State extends State<CheckPositionPage1> {
