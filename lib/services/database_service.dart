...
class DatabaseService {
  ...
  final CollectionReference friendsChatCollection = Firestore.instance
  ...
  Future createGroup(String userName, String groupName) async {
    ...
    return await userDocRef.updateData({
      'groups': FieldValue.arrayUnion(
          [groupDocRef.documentID + '_' + groupName])
  ...
  Future getUserData(String email) async {
    QuerySnapshot snapshot = await userCollection.where(
        ...
        .getDocuments(); //특정 이메일을 가지고있는 documents를 얻어옴
  ...
  sendMessage(String groupId, chatMessageData) {
    Firestore.instance.collection('groups').document(groupId).collection(
  ...
  sendMessageInFriendChat(String groupId, chatMessageData) {
    Firestore.instance.collection('friendsChatGroup')
        .document(groupId)
        .collection(
        'messages')
        .add(chatMessageData);
  ...
  getFriendChats(String groupId) async {
    return Firestore.instance.collection('friendsChatGroup').document(groupId)
        .collection(
